...
/// `MandArt3App` is the main structure for the SwiftUI app.
/// It defines the behavior and layout of the app.
@available(macOS 12.0, *)
@main
struct MandArt3App: App {
  @StateObject private var defaultDocument = MandArt3Document()
...
//          }
    ...
    DocumentGroup(newDocument: { MandArt3Document() }) { file in
