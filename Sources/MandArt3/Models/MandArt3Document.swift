/**
 MandArt3Document is a reference file document that supports only reading and writing MandArt data files that generate MandArt pictures.
...
/**
 ...
 Note: Since MandArt3Document is a class,  derive from [ReferenceFileDocument](
 https://developer.apple.com/documentation/swiftui/referencefiledocument
 )
 rather than FileDocument for a struct.
 */
@available(macOS 12.0, *)
final class MandArt3Document: ReferenceFileDocument, ObservableObject {
  ...
  static var readableContentTypes: [UTType] { [.mandart3DocType] }
